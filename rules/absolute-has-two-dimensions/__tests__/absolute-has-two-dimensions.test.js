...
const { ruleName, rule } = require('../absolute-has-two-dimensions');

const testRule = getTestRule({ plugins: ['./rules/absolute-has-two-dimensions/absolute-has-two-dimensions.js'] });
const { messages } = rule;
